...
(function (raiz) {
  ...
  /* ------------------------------------------------------ diagnostico */
  "faixa": "Estado do item hoje, avaliado nesta ordem: <b>Zerado com demanda</b> (sem peça e com demanda estimada), <b>Risco</b> (posição — físico mais trânsito — igual ou abaixo do ponto de pedido, e ponto de pedido positivo: item sem política não entra aqui, senão todo o catálogo que nunca girou cairia nesta faixa), <b>Sem giro</b> (há peça, mas sem venda há mais dias que o limiar da página), <b>Excesso</b> (físico acima do estoque máximo do modelo), <b>Saudável</b> (o resto). Um item cai numa faixa só, e só Risco conta o que está a caminho.",
  "acao": "O que o diagnóstico sugere para o item, na ordem: comprar (está zerado ou em risco e o plano já o pôs na fila), transferir (zerado ou em risco e o saldo das lojas cobre a demanda do período de proteção), revisar (zerado ou em risco e nem o plano nem a rede resolvem), liquidar (sem giro e o saldo em casa tem mais de 12 meses de idade FIFO — é a idade da peça, não o tempo sem vender), segurar (excesso ou sem giro com saldo mais novo que isso), manter (saudável). Na foto congelada não há idade FIFO, então nada aparece como liquidar.",
